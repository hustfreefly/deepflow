#!/usr/bin/env python3
"""
Ship Pro V8 - Dry Run Script

模拟完整的 Ship Pro V8 流程，验证所有组件集成正确。
"""
import json
import sys
...
from domains.ship_pro.orchestrator.state_manager import StateManager
