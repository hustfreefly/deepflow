# Ship Pro V6 - AI Native 架构

> **版本**: V6.0.0 | **日期**: 2026-07-03 | **状态**: 已实现，待测试

## 🎯 核心理念

**Ship Pro V6 = Solution Pro V2 的镜像架构**
...
├── tests/                        # 测试
│   └── test_ship_pro_v6.py      # 端到端测试
└── run_ship_pro_v6.py           # 启动脚本
```
...
python3 domains/ship_pro/v6/run_ship_pro_v6.py \
  --solution-pro-output /path/to/solution_pro_output.json \
  --blackboard-path /tmp/ship_pro_v6_blackboard
```
...
```bash
# 查看 ShipPackage
cat /tmp/ship_pro_v6_blackboard/stages/ship_package.json | jq

# 查看 Pipeline 状态
cat /tmp/ship_pro_v6_blackboard/pipeline_state.json | jq

# 查看所有阶段输出
ls -la /tmp/ship_pro_v6_blackboard/stages/
```
...
```bash
cd /Users/allen/.openclaw/workspace/.deepflow
pytest domains/ship_pro/v6/tests/test_ship_pro_v6.py -v
```
...
python3 domains/ship_pro/v6/run_ship_pro_v6.py \
  ...
  --blackboard-path /tmp/ship_pro_v6_e2e_test
```

## 📋 契约笼子方法

Ship Pro V6 严格遵循契约笼子方法：
...
```bash
ls domains/ship_pro/v6/contracts/schemas/
# planner_output.json
...
Ship Pro V6 吸收了 Solution Pro V2 的所有经验教训：

| # | Solution Pro 教训 | Ship Pro V6 改进 |
|---|------------------|-----------------|
...
- [架构设计](../../docs/design/ship_pro_v6_architecture.md)
- [角色规格](../../docs/design/ship_pro_v6_role_specifications.md)
- [收敛设计](../../docs/design/ship_pro_v6_convergence_design.md)
- [专家评审决策](../../docs/design/ship_pro_v6_expert_review_decisions.md)
...
- **V6.0.0** (2026-07-03): AI Native 架构，动态 Worker + 固定编排
