...
from domains.ship_pro.v6.agent import ShipAgent
...
def main():
    parser = argparse.ArgumentParser(description='Ship Pro V6 启动脚本')
    parser.add_argument(
        '--solution-pro-output',
        type=str,
        required=True,
    ...
    logger.info(f"🚀 Starting Ship Pro V6")
    ...
    try:
        ...
        logger.info(f"✅ Ship Pro V6 completed successfully")
        ...
        logger.error(f"❌ Ship Pro V6 failed: {e}", exc_info=True)
        return 1
