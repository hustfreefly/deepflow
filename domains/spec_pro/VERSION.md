...
| 层级 | 文件 | 当前值 | 含义 |
|------|------|--------|------|
| **Component** | `config/spec_pro.yaml` → `component_version` | `2.0.0` | Python 代码版本（coordinator + merge_spec + models 等） |
| **Prompt** | 各 `prompts/*.md` → `version` | `2.0.0` | Prompt 文件版本，独立于代码演进 |
