...
| 文档 | 内容 | 适合谁看 |
|:---|:---|:---|
| [1-系统总览.md](1-系统总览.md) | 三域全景图 + 数据流 + DAL 架构 + AI Native 设计原则 (V2.1.1) | 新人入门、全局理解 |
| [2-域详解.md](2-域详解.md) | 每个域的完整工作流程 + 关键组件 + 域详解 (V2.1.1) | 开发者、调试者 |
...
| [5-测试覆盖地图.md](5-测试覆盖地图.md) | 10 个测试套件 + 179+ 测试用例 (V2.1.1) | 测试工程师、质量保证 |
...
### 2026-07-08 (V2.1.1)
- ✅ AI Native 反模式修复（P0×5 + P1×10）
- ✅ DAL (Domain Adaptation Layer) 架构
